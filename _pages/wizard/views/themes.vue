<template>
  <div id="step-theme-selection" class="full-width row justify-center">
    <div id="step-theme-selection-content" class="tw-text-center tw-px-6">
      ...
      <!-- Choose Theme -->
      <div
        class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3 tw-gap-6"
        v-if="dataLoaded"
      >
        <div
        ...
        >
          ...
          <div
            class="tw-w-full tw-h-48 tw-overflow-hidden tw-rounded-md tw-relative tw-transition-all tw-duration-500 hover:tw-h-80 hover:tw-overflow-y-auto"
          >
            <img
              :src="theme.mediaFiles.internalimage.mediumThumb"
              :alt="theme.title"
              class="tw-w-full tw-object-cover tw-object-top"
            />
          </div>
